...
const logout_url = "http://127.0.0.1:8000/form/user-logout/";
        ...
        <div className="flex flex-row basis-1/12 justify-center bg-blue-200">
          <div className="flex flex-row basis-10/12 justify-center">
            ...
            <div className="flex flex-col basis-8/12">
              <div className="text-4xl font-lato font-semibold mx-auto">
                VELAMMAL MEDICAL COLLEGE
              </div>
              <div className="text-3xl font-lato font-medium mx-auto">
          ...
          <div className="flex flex-col basis-full">
            <div className="flex flex-col w-4/6 bg-white m-auto shadow-custom">
              {data.name === "Application" ? (
                ...
                <AdmissionForm data={data}></AdmissionForm>
              )}
            </div>
          </div>
        </div>
