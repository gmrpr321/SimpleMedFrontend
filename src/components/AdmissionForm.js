...
const admission_url = "http://127.0.0.1:8000/form/admission-form-create/";
const AdmissionForm = (props) => {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    const isEmptyField = Object.values(Section1data).some(
      (value) => value === ("" || false)
    );
    if (isEmptyField) {
      ...
      sleep(2000);
      axios
        .post(admission_url, Section1data)
        .then(() => {
        ...
        <div className="admission_form admission_first">
            ...
            <div className="admission_fields">
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  name="admission_no"
                  value={Section1data.admission_no}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                <label className="tag_label"></label>
                <input
                  hidden
                  className="tag_input"
                  type="text"
            ...
            <div className="admission_fields">
              <div className="admission_input-field">
                ...
                <input
                  ...
                  name="student_name"
                  value={Section1data.student_name}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  type="date"
                  name="date_of_birth"
                  value={Section1data.date_of_birth}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  name="father_name"
                  value={Section1data.father_name}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.father_phone_number}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.mother_phone_number}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.student_contact_no}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                <label className="tag_label">
                  Whether Day Scholar/Hostelite
                </label>
                <select
                  className="tag_select"
                  name="is_hostellite"
                  value={Section1data.is_hostellite}
                  onChange={handleChange}
                >
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.hsc_register_no}
                  onChange={handleChange}
                />
              </div>
            </div>
            ...
            <div className="admission_fields">
              <div className="admission_input-field">
                ...
                <select
                  className="tag_select"
                  name="board_of_study"
                  value={Section1data.board_of_study}
                  onChange={handleChange}
                >
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  name="neet_roll_no"
                  value={Section1data.neet_roll_no}
                  onChange={handleChange}
                />
              </div>
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.hsc_year_of_passing}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
              ...
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.neet_physics_percentile}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.neet_chemistry_percentile}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.neet_biology_percentile}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.neet_total_percentile}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.neet_total_mark}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.neet_study_center_name}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.hsc_physics_mark}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.hsc_chemistry_mark}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.hsc_biology_mark}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  placeholder="Enter Marks"
                  name="hsc_total_mark"
                  value={Section1data.hsc_total_mark}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.no_of_neet_attempts}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                <label className="tag_label">
                  Selection Committiee Allotment Order No
                </label>
                <input
                  className="tag_input"
                  type="text"
                  ...
                  value={Section1data.selection_committee_allotment_order_no}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                <label className="tag_label">
                  Selection Committiee General Rank:
                </label>
                <input
                  className="tag_input"
                  type="text"
                  ...
                  value={Section1data.selection_committee_general_rank}
                  onChange={handleChange}
                />
              </div>
              <div className="admission_input-field">
                ...
                <input
                  ...
                  value={Section1data.allotment_order_date}
                  onChange={handleChange}
                />
              </div>
            </div>
          ...
          <div className="admission_details admission_family mt-10">
            ...
            <div className="flex flex-row mb-28">
              <input
                className="mt-4 ml-10 w-4 hover:cursor-pointer"
                name="Checked"
                value={Section1data.Checked}
                type="checkbox"
                onChange={handleChange}
              ></input>
              <label className="ml-4 mt-4">
                I declare that the particulars mentioned above are true and I
                will not claim/ask for any change with regard to any of the
          ...
          <div className="admission_buttons">
            ...
            <button
              className="tag_button admission_sumbit"
