...
const ApplicationForm = (props) => {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    const isEmptyField = Object.values(applicationData).some(
      (value) => value === ("" || false)
    );
    if (isEmptyField) {
      alert("Please fill in all fields.");
      ...
      <form className={`${SectionActive} tag1_form`} action="#">
        <div className="application_form application_first">
          <div className="application_details application_personal">
            <span className="tag1_span application_title">
              Personal Details
            </span>
            ...
            <div className="application_fields">
              ...
              <div className="application_input-field">
                <label className="tag1_label">
                  Address of students staying Privately
                </label>
                <input
                  className="tag1_input"
                  type="text"
              ...
              <div className="application_input-field"></div>
            </div>
          </div>
          ...
          <div className="application_buttons">
            <div
              className="application_nextBtn tag1_button"
              onClick={handleNext}
            >
            ...
            <div className="application_fields">
              ...
              <div className="application_input-field">
                ...
                <input
                  ...
                  type="date"
                  name="DateofAdmit"
                  value={applicationData.DateofAdmit}
                  onChange={handleApplicationData}
                />
              </div>
            </div>
          ...
          <div className="application_details application_family mt-10">
            ...
            <div className="flex flex-row mb-28">
              <input
                ...
                name="Checked"
                value={applicationData.Checked}
                type="checkbox"
                onChange={handleApplicationData}
              ></input>
              <label className="ml-4 mt-4">
                I certify that the information given above by me is complete and
            ...
            <div className="application_buttons">
              ...
              <button
                className="tag1_button application_sumbit"
