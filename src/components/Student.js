...
const base_url = "http://127.0.0.1:8000/form/user-login/";
const Student = () => {
  ...
  const handleApplication = () => {
    const isEmptyField = Object.values(Application).some(
      (value) => value === ""
    );
    if (isEmptyField) {
      alert("Please fill in all fields.");
      ...
      <div className="flex flex-row basis-1/12 justify-center custom-gradient">
        <div className="flex flex-row basis-10/12 mt-2 justify-center">
          ...
          <div className="flex flex-col basis-8/12">
            <div className="text-4xl font-pavanam font-semibold mx-auto">
              VELAMMAL MEDICAL COLLEGE
            </div>
            <div className="text-3xl font-pavanam font-semibold mx-auto">
              HOSPITAL AND RESEARCH INSTITUTE
            </div>
          </div>
          <div className="flex flex-row-reverse basis-1/12 mt-5"></div>
        </div>
      </div>
      <div className="flex basis-11/12 bg-blue-50">
        <div
          className={`student_container ${swap} w-fit h-fit m-auto `}
          id="container"
        >
          <div className="student_form-container student_sign-up-container">
            <form className="student_form" action="#a">
              ...
              <input
                ...
                name="password"
                value={Admission.password}
                onChange={handleAdmissionChange}
              />
              <br></br>
              <div className="student_button mt-3" onClick={handleAdmission}>
                Log in
              </div>
            </form>
          </div>
          <div className="student_form-container student_sign-in-container">
            <form action="#a" className="student_form">
              ...
              <br></br>
              <div
                className="student_button hover:cursor-pointer"
          ...
          <div className="student_overlay-container">
            <div className="student_overlay">
              <div className="student_overlay-panel student_overlay-left">
                ...
                <button
                  className="student_button ghost"
                  id="signIn"
                  onClick={swapAdmin}
                >
                  Application
